...
- [Pagina web](https://miguelramosalarcon.github.io/100DaysOfProjects/92-day-explore-landing-page/)
- [Codigo fuente]()
...
Usamos `javascript` para dar el efecto de nieve:
